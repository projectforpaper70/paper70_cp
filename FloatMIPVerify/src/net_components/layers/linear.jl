...
function matmul(x::Array{<:Real,1}, params::Linear)
    # println("real matmul the size of input is :")
    # println(size(x))
    # println("the content is : ")
    # println(x)
    # println("real matmul the size of matrix is :")
    # println(size(params.matrix))
    # println("the content is :")
    # println(params.matrix)
    # println("type of matrix is :")
    # println(typeof(params.matrix))
