...
|------------------------------|-------------------|------------|-------|---------------|---------------|-------------------|--------------|--------------|
| $\mathrm{MNIST}_{7 \times 7}^{H}$    | $\mathrm{MLP}_{a}^{H}$ | 0          | 5000  | 4975          | 25            | 5000              | 0            | 0            |
| $\mathrm{MNIST}_{28 \times 28}^{H}$  | $\mathrm{MLP}_{b}^{H}$ | 0          | 5000  | 4987          | 13            | 4998              | 0            | 2            |
| $\mathrm{MNIST}_{7 \times 7}^{H}$    | $\mathrm{MLP}_{a}^{H}$ | 0.05       | 5000  | 367           | 4633          | 415               | 2880         | 1705         |
| $\mathrm{MNIST}_{28 \times 28}^{H}$  | $\mathrm{MLP}_{b}^{H}$ | 0.05       | 5000  | 1516          | 3484          | 1719              | 1736         | 1545         |
| $\mathrm{MNIST}_{7 \times 7}^{H}$    | $\mathrm{MLP}_{a}^{H}$ | 0.1        | 5000  | 2             | 4998          | 3                 | 3926         | 1071         |
| $\mathrm{MNIST}_{28 \times 28}^{H}$  | $\mathrm{MLP}_{b}^{H}$ | 0.1        | 5000  | 73            | 4927          | 81                | 3083         | 1836         |
